;; -*- lisp-version: "8.2 [Linux (x86)] (Jan 25, 2010 15:03)"; cg: "1.134"; -*-

(in-package :cg-user)

(define-project :name :my_defuns
  :modules (list (make-instance 'module :name "add_third.lisp")
                 (make-instance 'module :name "my_fourth.lisp")
                 (make-instance 'module :name "check_len.lisp")
                 (make-instance 'module :name "equal_test.lisp")
                 (make-instance 'module :name "funcmax.lisp")
                 (make-instance 'module :name "replNZP_iter.lisp")
                 (make-instance 'module :name "replNZP_mapcar.lisp")
                 (make-instance 'module :name "replNZP_recur.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
